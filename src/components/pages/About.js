...
class About extends Component {
  render() {
    return (
      <Parallax blur={0} bgImage={require("../../Assets/images/background-boardwalk-clouds-808465.jpg")} bgImageAlt="Moutain Background" strength={300}>
        <div className="about">
          <div className="dark-bg">
            ...
            <div className="p1">
              <p>A software engineering student who enjoys coding and playing football.</p>
            </div>
          </div>
              ...
              <Item.Group>
                <Item>
                  ...
                  <Item.Content>
                    ...
                    <Item.Description>
                      <p>
                        Configured basic AWS EC2, Lambda, S3, IAM and SNS functionality via Terraform. Implemented back-end improvements using C#, .NET
                        Framework, ASP.NET MVC, Entity Framework, and SQL Server. Designed testable code, wrote unit tests using NUnit and Moq. Improved
                        application security by fixing vulnerabilities revealed from a penetration test. Proficient with dependency injection frameworks.
                        Performed code reviews to improve code quality.{" "}
                      </p>
                    </Item.Description>
                  </Item.Content>
                </Item>
                <Item>
                  ...
                  <Item.Content>
                    ...
                    <Item.Description>
                      <p>
                        Involves scheduling lessons and travelling to student's homes. Providing non-classroom support and employing learning strategies to help
                        students understand the more difficult concepts. Monitoring the student's progress and ensuring they are well prepared for upcoming
                        assignments and tests. Communicating the student's progress to the parents in written reports.
                      </p>
                    </Item.Description>
                  </Item.Content>
                </Item>
